#' @description Calculate surface kurtosis for an input landscape using a moving window analysis using a matrix
...
#'
#' @details
#' This function calculates surface kurtosis values for each cell by applying a moving window of a specified size
...
#'
#' #Apply the function
#' mySku <- moving_Sku(landscape, mywindow)
#' plot(mySku)
#'
#' #Outputing it to a file
#' mySku2 <- moving_Sku(landscape, mywindow, filename="./mySku.tiff")
#' }
#'
#' @references
