...
#'
#' @description Calculate the maximum peak height of the positive values in the landscape using a moving window
...
#'
#' @details
#' This function calculates maximum peak height for each cell by applying a moving window of a specified size
...
moving_Sp <- function(landscape, moving_window, filename=''){
  require(raster)
