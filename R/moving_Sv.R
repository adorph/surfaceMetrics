#' Calculates the Minimum Peak Height of a Surface Image
#'
#' @description Calculate the minimum peak height of the positive values in the landscape using a moving window
...
#'
#' @details
#' This function calculates minimum peak height for each cell by applying a moving window of a specified size
...
moving_Sv <- function(landscape, moving_window, filename=''){
  require(raster)
