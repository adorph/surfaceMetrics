...
#' around a site that you want to be measured and calculates surface kurtosis that area.
#' It returns a single value for that layer.
#'
#' @param landscape Raster* Layer clipped to the scale you want to measure
#'
#' @details
#' This function calculates a surface kurtosis value for supplied raster. The function
